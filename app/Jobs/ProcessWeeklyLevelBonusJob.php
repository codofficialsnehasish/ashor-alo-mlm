    ...
    public function handle()
    {
        foreach ($this->transactions as $key => $value) {
            ...
            foreach($income_data as $data){
                $lastSaturday = Carbon::createFromFormat('Y-m-d H:i:s', $this->start_date);
                $today = Carbon::createFromFormat('Y-m-d H:i:s', $this->end_date);
                ...
                // \Log::info("user : ".$key.", days : ".$days." weekly payment : ".$weeklyPayment);
