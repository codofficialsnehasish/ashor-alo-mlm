...
class AccountTransaction extends Model
{
    ...
    function make_transaction($user_id, $amount, $which_for, $status,$generated_against_id=null,$topup_id=null, $customCreatedAt = null, $customUpdatedAt = null){
