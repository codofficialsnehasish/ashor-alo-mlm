...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Franchise Benefit</li>
                        </ol>
                    </div>
                    <div class="col-md-4">
            ...
            <form class="custom-validation" action="{{ route('franchise-benefit.update',$item->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-9">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="text" type="text"
                                            ...
                                            placeholder="" name="name" value="{{ $item->name }}" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="amount" value="{{ $item->amount }}" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="income" value="{{ $item->income }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
