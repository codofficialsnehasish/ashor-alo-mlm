...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add new Monthly Return</li>
                        </ol>
                    </div>
                    <div class="col-md-4">
            ...
            <form class="custom-validation" action="{{ route('monthly-return.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="form_amount" value="">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="to_amount" value="">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="number" class="form-control" placeholder="" value="" id="percentage" aria-describedby="inputGroupPrepend" name="percentage" required>
