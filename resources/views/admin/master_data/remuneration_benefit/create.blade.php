...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add new new Remuneration Benefit</li>
                        </ol>
                    </div>
                    <div class="col-md-4">
            ...
            <form class="custom-validation" action="{{ route('remuneration-benefit.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="text" type="text"
                                            ...
                                            placeholder="" name="rank" value="" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="target" value="" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="bonus" value="" required>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div>
                                        <input data-parsley-type="number" type="number"
                                            ...
                                            placeholder="" name="month_validity" value="" required>
                                    </div>
                                </div>
                            </div>
                        </div>
