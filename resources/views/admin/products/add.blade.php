    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form class="custom-validation" action="{{ route('products.process') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div>
                                            <input data-parsley-type="text" type="text" class="form-control" required placeholder="Enter Title" name="name">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="is_addon1" name="is_addon" class="form-check-input" value="1">
                                            <label class="form-check-label" for="is_addon1">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="is_addon2" name="is_addon" class="form-check-input" value="0" checked>
