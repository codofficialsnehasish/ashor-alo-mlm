                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a href="{{ route('products.add-new') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ $product->product_image }}" width="100px" alt=""></td>
                                                    <td>{!! check_visibility($product->is_visible) !!}</td>
                                                    <td>
                                                        <a class="btn btn-primary" href="{{ route('products.edit',$product->id) }}" alt="edit"><i class="ti-check-box"></i></a>
