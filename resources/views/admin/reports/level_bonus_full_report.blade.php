        ...
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="float-end d-none d-md-block">
                            <div class="dropdown">
                                <a href="{{ route('report.level-bonus-report') }}" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('report.generate-level-bonus-full-details',$user_id) }}" method="post">
                                @csrf
                                <div class="row">
