        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('report.generate-remuneration-transaction-report') }}" method="post">
                                @csrf
                                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="2"><b>Total User - {{ $user }}</b></td>
                                        <td colspan="2"><b>Total Amount - {{ $amount }}</b></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
