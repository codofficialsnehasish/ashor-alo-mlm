            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h6 class="h6 mb-0 text-gray-800"><strong>Reference Link:</strong> 
                        <!-- AddToAny BEGIN -->
                        <div class="a2a_kit a2a_kit_size_32 a2a_default_style" data-a2a-url="{{ url('/member-register') }}?sponsorid={{ Auth::user()->phone }}" data-a2a-title="Get Business Opportunity on ASHOR ALO. Join today using below link" style="line-height: 32px;">
                        <a class="a2a_dd" href="https://www.addtoany.com/share'#url={{ url('/member-register') }}?sponsorid={{ Auth::user()->phone }}&amp;title={{ urlencode('Get Business Opportunity on ASHOR ALO. Join today using below link') }}"><span class="a2a_svg a2a_s__default a2a_s_a2a" style="background-color: rgb(1, 102, 255);"><svg focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><g fill="#FFF"><path d="M14 7h4v18h-4z"></path><path d="M7 14h18v4H7z"></path></g></svg></span><span class="a2a_label a2a_localize" data-a2a-localize="inner,Share">Share</span></a>
