    ...
    @if ($user->children->count() > 0)
        <ul class="active">
            @foreach ($user->children->where('is_left', 1) as $child)
                @include('site.user_dashboard.member_management.tree-node', ['user' => $child])
            @endforeach
...
<li>
    ...
    <ul>
        ...
        @endphp
        @if ($leftChild)
            @include('site.user_dashboard.member_management.tree-node', ['user' => $leftChild])
        @else
            <li>
                <a href="javascript:void(0);">
                    <div class="member-view-box">
        ...
        @endif
        @if ($rightChild)
            @include('site.user_dashboard.member_management.tree-node', ['user' => $rightChild])
        @else
            <li>
                <a href="javascript:void(0);">
                    <div class="member-view-box">
