                                ...
                                <div class="d-flex align-items-center justify-content-center text-center" id="PrintMe">
                                    {{--<div class="id_card mr-3">
                                        ...
                                        <div class="dr_profile">
                                            <img src="{{!empty($user->user_image) ? asset($user->user_image) : asset('dashboard_assets/images/users/user-13.jpg')}}" alt="" height="100" width="60">
                                        </div>
                                        <div class="card_information">
                                            <h3 class="dr_name">{{ $user->name }}</h3>
                                            <h4>ID : <span>{{ $user->user_id }}</span></h4>
                                            <h6>Mobile : <span>{{ $user->phone }}</span></h6>
                                    ...
                                    <div class="id-card-holder">
                                        <div class="id-card">
                                            ...
                                            <div class="photo">
                                                <img src="{{!empty($user->user_image) ? asset($user->user_image) : asset('dashboard_assets/images/users/user-13.jpg')}}">
                                            </div>
                                            <h2>{{ $user->name }}</h2>
                                            <!-- <div class="qr-code">
