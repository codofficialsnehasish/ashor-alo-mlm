            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Welcome Letter</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div id="printableArea" class="table-responsive" style="line-height:1.9;border: 6px solid #979696;padding:20px;border-radius: 15px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <b>Aheartly Welcome To {{ Auth::user()->name }}</b>
                                        <p>Dear,Mr./Miss/Mrs./Ms : {{ Auth::user()->name }},</p>
                                        <p>ID : {{ Auth::user()->user_id }},</p>
                                    </div>
                                    <div class="col-md-6">
                                        <div style="padding: 5px;text-align:right;">
                                            <b>DATE : {{ formated_date(Auth::user()->created_at) }}</b>
                                        </div>
                                    </div>
                                </div>
